  ...
  /******/ var __webpack_modules__ = {
    /***/ 1478: /***/ function () {
      ...
      (function () {
        ...
        const getAdState = () => {
          try {
            const currentAdBreak =
              getPlayerApi().state.playbackState.currentAdBreak;
        ...
        const getPlayerApi = () => {
          try {
            return getReactInternals(document.querySelector(".watch-video"))
              .return.return.return.return.return.stateNode;
          } catch (e) {
            return undefined;
          }
        };
        const getCurrentMetaData = () => {
          try {
            return getWrapperStateNode().state.activeVideoMetadata._metadata
              ._metadata.video;
          } catch (error) {
            return undefined;
          }
        ...
        function findPlayElement() {
          var controlsRoot = document.querySelector(
            ...
            const checkForCondition = function () {
              ...
              if (
                ...
                return Promise.reject(
                  new Error("delayUntil timed out" + condition),
                );
              }
        ...
        const checkSkipSupplemental = () =>
          __awaiter(this, void 0, void 0, function* () {
            try {
              yield delayUntil(() => {
                try {
                  return (
                    getWrapperStateNode().state.activeVideoMetadata._video !=
                    undefined
                  );
                } catch (e) {
                  return false;
              ...
              if (
                getWrapperStateNode().state.activeVideoMetadata._video.type ==
                "supplemental"
              ) {
        ...
        const getEpisodeInformation = () => {
          const title =
            getWrapperStateNode().state.activeVideoMetadata._video.title;
          const episodeNum =
            getWrapperStateNode().state.activeVideoMetadata._video.seq;
          const seasonNum =
            getWrapperStateNode().state.activeVideoMetadata._season._season.seq;
          const episodeData = {
            title: title,
            seasonNum: seasonNum,
        ...
        const changeEpisodeFallback = (id) =>
          __awaiter(this, void 0, void 0, function* () {
            try {
              var fakeEvent = {
                stopPropagation: () => {},
          ...
          try {
            if (e.source == window) {
              if (e.data.type && e.data.type === "SEEK") {
                ...
                e.data.type &&
                e.data.type === "CheckSkipSupplemental"
              ) {
                ...
                let evt = new CustomEvent("FromNode", {
                  detail: { type: "GetType", VideoType, updatedAt: Date.now() },
                });
                window.dispatchEvent(evt);
